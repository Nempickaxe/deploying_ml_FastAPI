...
- Train a ML model on a classification task to predict salary group of individuals based on 14 various characteristics. The threshold salary used is $50,000. You can refer for the detailed modelCard [here](https://github.com/Nempickaxe/deploying_ml_FastAPI/blob/main/model_card_template.md) for details on the model and dataset used
...
* See the screenshots as illustrations [here](https://github.com/Nempickaxe/deploying_ml_FastAPI/tree/main/screenshots)
